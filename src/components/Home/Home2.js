...
And my favorite coding language has been Javascript and I'm conversant with 
              <i>
                <b className="purple"> Python, Javascript and sometimes C++ & Java. </b>
              </i>
              <br />
              <br />
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/dagwal3"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/dagim-wallelgne/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
